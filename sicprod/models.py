...
class Person(TempEntityClass):
    """ Person, auto generated from model xml """
...
class Function(TempEntityClass):
    """ Function, auto generated from model xml """
    alternative_label = models.TextField(blank=True, null=True)


@reversion.register(follow=["tempentityclass_ptr"])
class Place(TempEntityClass):
    """ Place, auto generated from model xml """
    alternative_label = models.TextField(blank=True, null=True)
...
class Institution(TempEntityClass):
    """ Institution, auto generated from model xml """
    alternative_label = models.TextField(blank=True, null=True)
...
class Court(TempEntityClass):
    """ Court, auto generated from model xml """
    alternative_label = models.TextField(blank=True, null=True)
...
class Event(TempEntityClass):
    """ Event, auto generated from model xml """
    alternative_label = models.TextField(blank=True, null=True)
...
class Salary(TempEntityClass):
    """ Salary, auto generated from model xml """
